...
Mesh& BuildTent(MeshManager& mgr)
{
	// Create vertex buffer
	VertexPosNormTex vertices[] =
	{	//front
		{ Vector3(-0.5f, 0, -0.5f), Vector3(0, 0, -1), Vector2(0, 0) },
		{ Vector3(0, 0.5f, -0.5f), Vector3(0, 0, -1), Vector2(0, 0) },
		{ Vector3(0.5f, 0, -0.5f), Vector3(0, 0, -1), Vector2(0, 0) },
		//right
		{ Vector3(0.5f, 0, -0.5f), Vector3(0.7f, 0.7f, 0), Vector2(0, 0) },
		{ Vector3(0, 0.5f, -0.5f), Vector3(0.7f, 0.7f, 0), Vector2(0, 0) },
		{ Vector3(0, 0.5f, 0.5f), Vector3(0.7f, 0.7f, 0), Vector2(0, 0) },
		{ Vector3(0.5f, 0, 0.5f), Vector3(0.7f, 0.7f, 0), Vector2(0, 0) },
		//left
		{ Vector3(-0.5f, 0, -0.5f), Vector3(-0.7f, 0.7f, 0), Vector2(0, 0) },
	...
	Mesh &mesh = mgr.CreateMesh("tent");
	MaterialExt mat = MaterialExt::default;

	mesh.CreateFrom(vertices, 14, indices, 18, mat, 0, 18);
	return mesh;
}
...
Mesh& BuildCube(MeshManager& mgr)
{
	...
	VertexPosNormTex vertices[] =
	{	//front
		{ Vector3(-1, -1, -1), Vector3(0, 0, -1), Vector2(0, 3) },
		{ Vector3(-1, 1, -1), Vector3(0, 0, -1), Vector2(0, 0) },
		{ Vector3(1, 1, -1), Vector3(0, 0, -1), Vector2(1, 0) },
		{ Vector3(1, -1, -1), Vector3(0, 0, -1), Vector2(1, 3) },
		//right
		{ Vector3(1, -1, -1), Vector3(1, 0, 0), Vector2(0, 3) },
		{ Vector3(1, 1, -1), Vector3(1, 0, 0), Vector2(0, 0) },
		{ Vector3(1, 1, 1), Vector3(1, 0, 0), Vector2(1, 0) },
		{ Vector3(1, -1, 1), Vector3(1, 0, 0), Vector2(1, 3) },
		//left
		{ Vector3(-1, -1, 1), Vector3(-1, 0, 0), Vector2(0, 3) },
		{ Vector3(-1, 1, 1), Vector3(-1, 0, 0), Vector2(0, 0) },
		{ Vector3(-1, 1, -1), Vector3(-1, 0, 0), Vector2(1, 0) },
		{ Vector3(-1, -1, -1), Vector3(-1, 0, 0), Vector2(1, 3) },
		//top
		{ Vector3(-1, 1, -1), Vector3(0, 1, 0), Vector2(0, 3) },
		{ Vector3(-1, 1, 1), Vector3(0, 1, 0), Vector2(0, 0) },
		{ Vector3(1, 1, 1), Vector3(0, 1, 0), Vector2(1, 0) },
		{ Vector3(1, 1, -1), Vector3(0, 1, 0), Vector2(1, 3) },
		//bottom
		{ Vector3(1, -1, -1), Vector3(0, -1, 0), Vector2(0, 3) },
		{ Vector3(1, -1, 1), Vector3(0, -1, 0), Vector2(0, 0) },
		{ Vector3(-1, -1, 1), Vector3(0, -1, 0), Vector2(1, 0) },
	...
	MaterialExt mat = MaterialExt::default;
	mat.gfxData.Diffuse = Vector4(1, 1, 1, 1);
	mat.gfxData.Ambient = Vector4(1.0f, 1.0f, 1.0f, 1);
	mat.gfxData.Specular = Vector4(1, 1, 1, 10);
...
Mesh& BuildSphere(MeshManager& mgr, int LatLines, int LongLines)
{
	...
	MaterialExt mat = MaterialExt::default;
	mat.gfxData.Diffuse = Vector4(1, 1, 1, 1);
	mat.gfxData.Specular = Vector4(1, 1, 1, 50.f);
