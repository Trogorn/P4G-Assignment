...
public:
	...
	//with a FPS camera you want the mouse move information, but you have to keep
	//centering the mouse on the screen so you can spin in circles without the mouse
	//leaving the window
	DirectX::SimpleMath::Vector2 GetMouseMoveAndCentre();
...
private:
	...
	DirectX::SimpleMath::Vector2 mMouseScreen, mMouseMove, mCentredMouseMove;
